...
function Skills() {
  return (
    <div id="skill" className="h-full my-[4rem]">
      <h1 className="font-bold text-3xl sm:text-4xl my-2 text-center">
        Skills
      </h1>
      <p className="text-gray-700 text-center">
        My Technical and Miscellanous Skills
      </p>
      <div className="text-[#6e57e0] flex flex-col sm:flex-row justify-center w-full my-8">
        <Accordion
          type="single"
          collapsible
          className="flex flex-wrap justify-center items-center w-full sm:w-full gap-4 p-4 border-none"
        >

<AccordionItem
            value="item-1"
            className="no-underline w-[18rem] sm:w-[40%]"
          >
            <AccordionTrigger className="text-2xl sm:text-3xl flex justify-between font-bold font-mono">
              <div className="flex align-middle gap-4 justify-center">
                <LuBrainCog size={32} />
            ...
            <AccordionContent className="flex justify-center">
              <ul className="text-xl text-start text-black w-full sm:w-3/4">
                <li className="hover:text-2xl">Machine Learning</li>
                <li className="hover:text-2xl">EDA</li>
                <li className="hover:text-2xl">Deep Learning</li>
                <li className="hover:text-2xl">Feature Engineering</li>
